...
namespace ExpectObjectToBeLikeTest;


class ExpectObjectToBeLikeTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testMissingExpectedAttribute()
    {
        ...
        try{
            ...
            $this->assertEquals(
                "The object was expected to have an attribute defined at 'name'.",
                $e->getMessage()
            );
